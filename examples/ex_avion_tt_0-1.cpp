...
/*
		...
		*/
		...
		const ExprNode* e=&((1000*sqr(Q[0]*Delta[0])-Tm[0]));
		for (int i=1; i<n; i++)
			e = & (*e + (1000*sqr(Q[i]*Delta[i])-Tm[i]));
		Function f_cost(Tm,Delta,Q,*e);
